...
# Settings
random_seed = 612
n_generations = 2990       # resuming from generation 10 -> reaches 3000 total for this lineage
save_freq = 10
...
resume_checkpoint = os.path.join(local_dir, "neat_run18_full", "checkpoint-10")
# run 18's own champions (43-52), deliberately NOT the weaker 36-42
