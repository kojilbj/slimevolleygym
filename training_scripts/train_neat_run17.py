...
# Settings
random_seed = 612
n_generations = 2296       # resuming from generation 2704 -> reaches 5000 total
save_freq = 10
...
resume_checkpoint = os.path.join(local_dir, "neat_run16_full", "checkpoint-2704")
# champions 1-35 in run 11's logdir, 36-38 in run 13's, 39 in run 14's,
# 40 in run 15's, 41-42 in run 16's
resume_logdirs = [os.path.join(local_dir, "neat_run11_full"),
                   ...
                   os.path.join(local_dir, "neat_run16_full")]
# manually reintroduced into the archive on top of the normal reload
# (see run 16's header comment) -- champion_0035 had rotated out and
# nothing since had to prove itself against it. Keep it in for run 17 too.
reintroduce_champions = [os.path.join(local_dir, "neat_run11_full", "champion_0035.pkl")]

logdir = "neat_run17_full"
