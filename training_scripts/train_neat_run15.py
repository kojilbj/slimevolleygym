...
# Settings
random_seed = 612
n_generations = 2478       # resuming from generation 2522 -> reaches 5000 total
save_freq = 10
...
resume_checkpoint = os.path.join(local_dir, "neat_run14_full", "checkpoint-2522")
# champions 1-35 in run 11's logdir, 36-38 in run 13's, 39 in run 14's -- search all
