...
# Settings
random_seed = 612
n_generations = 2884       # resuming from generation 116 -> reaches 3000 total for this lineage
save_freq = 10
...
resume_checkpoint = os.path.join(local_dir, "neat_run19_full", "checkpoint-121")
# run 18's and run 19's own champions, deliberately NOT the weaker 36-42
