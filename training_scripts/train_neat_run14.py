...
# Settings
random_seed = 612
n_generations = 2979       # resuming from generation 2021 -> reaches 5000 total
save_freq = 10
n_rollouts = 6             # per-genome fitness rollouts, vs opponents sampled from the archive (was 3)
...
resume_checkpoint = os.path.join(local_dir, "neat_run13_full", "checkpoint-2021")
# champions 1-35 live in run 11's logdir, 36-38 in run 13's -- search both
resume_logdirs = [os.path.join(local_dir, "neat_run11_full"), os.path.join(local_dir, "neat_run13_full")]

logdir = "neat_run14_full"
